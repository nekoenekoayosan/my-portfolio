...
export default async function PortfolioPage() {
  ...
  return (
    <main className="min-h-screen bg-black text-white">
      <header className="border-b border-white/10 px-4 py-4 md:px-8 md:py-6 flex items-center justify-between">
        <h1 className="text-base md:text-lg font-bold tracking-widest uppercase">Portfolio</h1>
      ...
      <div className="px-4 py-8 md:px-8 md:py-12 max-w-6xl mx-auto w-full">
        {error && (
          <div className="border border-red-500/60 bg-red-950/40 rounded-lg p-5">
            <p className="text-red-400 font-semibold mb-1">データの取得に失敗しました</p>
        ...
        {data && (
          <>
            <p className="text-white/30 text-sm mb-6 md:mb-8">{data.results.length} 件の作品</p>
